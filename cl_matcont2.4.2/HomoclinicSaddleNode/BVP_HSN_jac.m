...
for j=1:homds.nphase+2
    ...
    if ~isempty(YU)
        ...
        for i=1:homds.nneg+1
            result(homds.ncoords+2+1:homds.ncoords+2+1+homds.npos*(homds.nneg+1),homds.ncoords+j) = tmp(:,i);
        end    
    end
    if ~isempty(YS)
        ...
        for i=1:homds.npos+1
            result(homds.ncoords+2+homds.npos*(homds.nneg+1)+1:homds.ncoords+2+homds.npos*(homds.nneg+1)+homds.nneg*(homds.npos+1),homds.ncoords+j) = tmp(:,i);
        end
    end
end
